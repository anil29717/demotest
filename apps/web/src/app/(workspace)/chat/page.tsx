...
export default function ChatPage() {
  ...
  return (
    <div className="mx-auto max-w-xl rounded-xl border border-zinc-800 bg-zinc-950/40">
      <div className="border-b border-zinc-800 px-4 py-4">
        <h1 className="text-lg font-semibold text-white">Chat</h1>
        <p className="mt-1 text-[12px] text-zinc-500">Open a thread for full conversation and live typing.</p>
      </div>
